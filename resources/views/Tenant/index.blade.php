            ...
            <form action="javascript:void(0)" method="POST" id="formInsert">
              <div class="modal-body">
                <div class="form-group">
                  <label for="code">Kode Tenant</label>
                  <input type="text" class="form-control" id="code" name="code" placeholder="Input Kode Tenant" required>
                </div>
                <div class="form-group">
                  <label for="name">Nama Tenant</label>
                  <input type="text" class="form-control" id="name" name="name" placeholder="Input Nama Tenant" required>
                </div>
                <div class="form-group">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form action="javascript:void(0)" method="POST" id="formUpdate">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <label for="codeUpdate">Kode Tenant</label>
                  <input type="text" class="form-control" id="codeUpdate" name="code" placeholder="Input Kode Tenant" required>
                </div>
                <div class="form-group">
                  <label for="nameUpdate">Nama Tenant</label>
                  <input type="text" class="form-control" id="nameUpdate" name="name" placeholder="Input Nama Tenant" required>
                </div>
                <div class="form-group">
